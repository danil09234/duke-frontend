...
export function WelcomeCard({
  ...
  return (
    <div
      className="flex w-full overflow-vidible flex-col justify-center items-center px-8 py-12 bg-white rounded-lg border border-gray-200 border-solid shadow-sm max-md:px-5 gap-6"
      style={{
